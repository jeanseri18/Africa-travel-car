...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-9">
            <h1 class="mb-4">Liste des Destinations Nationales</h1>
        </div>
        <div class="col-md-3">

            <a href="{{ route('destinations_national.create') }}" class="btn btn-primary mb-3">Ajouter une
                Destination</a>
        </div>
    </div>
    <br>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('destinations_national.destroy', $destination->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('DELETE')
